...
var sw;
var hue1=0,hue2=50,hue3=100,hue4=150,hue5=200;
var hue = 0;
function PWLineInit(){
	...
	switch (PWLineParam.ColorMode){
		...
		case 3:
			...
			if(PWLineParam.ColorRhythm){
				rainbow.addColorStop("0", getColor(5));
				rainbow.addColorStop(".25", getColor(4));
				rainbow.addColorStop(".50", getColor(3));
				rainbow.addColorStop(".75", getColor(2));
